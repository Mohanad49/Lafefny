            ...
            <li key={itinerary._id} className="itinerary-item">
              <div className="itinerary-card">
                ...
                <div className="itinerary-actions">
                  <Link to={`/edit-tourist-itinerary/${itinerary._id}`} className="edit-button">Edit</Link>
                  <button onClick={() => handleDelete(itinerary._id)} className="delete-button">Delete</button>
                </div>
              </div>
            </li>
          ))}
